...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_x4,   mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a720, mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a520, mProcessorInfoType4Strings, NULL);
}
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  mProcessorInfoType4_x4.L1CacheHandle   = (UINT16)SmbiosHandle;
  mProcessorInfoType4_a720.L1CacheHandle = (UINT16)SmbiosHandle;
